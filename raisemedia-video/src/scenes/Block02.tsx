...
const useLocal = (frame: number, from: number, dur: number) => {
  ...
  const fadeIn = interpolate(local, [0, 10], [0, 1], { easing: easings.enter, extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  const fadeOut = interpolate(local, [dur - 8, dur], [1, 0], { easing: easings.exit, extrapolateLeft: "clamp", extrapolateRight: "clamp" });
